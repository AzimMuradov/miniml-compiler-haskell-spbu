...
if.then_0:
  ...
  br label %if.end_0 
if.else_0:
  %anf.11_0 = ptrtoint i64 (i64, i64)* @cps_factorial.3 to i64 
  %anf.11_1 =  call ccc  i64  @miniml_fun_to_paf(i64  %anf.11_0, i64  2)  
  %anf.11_2 = sub   i64 %n.4_0, 1 
  %anf.11_3 =  call ccc  i64  @miniml_apply(i64  %anf.11_1, i64  %anf.11_2)  
  %anf.12_0 = ptrtoint i64 (i64, i64, i64)* @ll.10 to i64 
  %anf.12_1 =  call ccc  i64  @miniml_fun_to_paf(i64  %anf.12_0, i64  3)  
  %anf.12_2 =  call ccc  i64  @miniml_apply(i64  %anf.12_1, i64  %n.4_0)  
  %anf.13_0 =  call ccc  i64  @miniml_apply(i64  %anf.12_2, i64  %k.5_0)  
  %6 =  call ccc  i64  @miniml_apply(i64  %anf.11_3, i64  %anf.13_0)  
  store  i64 %6, i64* %1 
  br label %if.end_0 
if.end_0:
  %7 = load  i64, i64* %1 
...
define external ccc  i64 @factorial.8(i64  %n.7_0)    {
  ...
  %anf.14_2 =  call ccc  i64  @miniml_apply(i64  %anf.14_1, i64  %n.7_0)  
  %1 = ptrtoint i64 (i64)* @id.2 to i64 
  %2 =  call ccc  i64  @miniml_fun_to_paf(i64  %1, i64  1)  
  %3 =  call ccc  i64  @miniml_apply(i64  %anf.14_2, i64  %2)  
  ret i64 %3 
}
...
define external ccc  i64 @main()    {
  %anf.15_0 = ptrtoint i64 (i64)* @factorial.8 to i64 
  %anf.15_1 =  call ccc  i64  @miniml_fun_to_paf(i64  %anf.15_0, i64  1)  
  %anf.15_2 =  call ccc  i64  @miniml_apply(i64  %anf.15_1, i64  5)  
