...
start:
  ...
  %0 = icmp sgt i64 %i.3_0, %n.1_0
  %1 = zext i1 %0 to i64
  %2 = trunc i64 %1 to i1
  br i1 %2, label %if.then_0, label %if.else_0
if.then_0:
  store i64 %accum.4_0, ptr %stack.ptr_0
  br label %if.end_0
if.else_0:
  %3 = ptrtoint ptr @loop.2 to i64
  %4 = call ccc i64 @miniml_fun_to_paf(i64 %3, i64 3)
  %5 = call ccc i64 @miniml_apply(i64 %4, i64 %n.1_0)
  %6 = add i64 %i.3_0, 1
  %7 = call ccc i64 @miniml_apply(i64 %5, i64 %6)
  %8 = mul i64 %accum.4_0, %i.3_0
...
start:
  ...
  %3 = call ccc i64 @miniml_apply(i64 %2, i64 1)
...
start:
  %0 = ptrtoint ptr @factorial.5 to i64
